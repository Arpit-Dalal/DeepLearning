...
# Initialize the model with correct input shape (16 for a flattened 4x4 grid)
input_shape = 16  # Change this to reflect the flattened grid size
action_space = env.action_space.n  # Number of possible actions (up, down, left, right)
...
for e in range(EPISODES):
    ...
    while True:
        ...
        # Reshape next_state correctly for ANN input (1 sample with 16 features)
        ...
        # Train the model with the new Q-value
